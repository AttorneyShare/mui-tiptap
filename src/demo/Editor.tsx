...
const exampleContent =
  "Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum \n\nBlah blah blah \n\n The rain in Spain is mostly in the plain.\nWords!\nLine 1\nLine 2 \nLine 3 ";

// NOTE: We need to replace the plaintext newlines with paragraph elements so
// that TipTap handles the formatting correctly.
const formattedExampleContent = exampleContent
  .match(/^.*$/gm)
  ?.map((line) => `<p>${line}</p>`)
  .join("");
    ...
    <>
      ...
      >
        <RichTextEditor
          ...
          content={formattedExampleContent}
          editable={isEditable}
          editorProps={{
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    // NOTE: This re-inserts the "\n" characters that were
                    // present in the original exampleContent string. There is no
                    // HTML embedded in this string.
